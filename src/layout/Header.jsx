...
import { Phone, Mail, Search, ShoppingCart, Heart, User, ChevronRight } from 'lucide-react';
...
const Header = () => {
  ...
  return (
    <header className="w-full font-sans">
      {/* Üst İletişim Çubuğu */}
      <div className={`${isShopPage ? 'bg-[#23856D]' : 'bg-[#252B42]'} text-white py-3 hidden md:flex justify-between items-center px-6 lg:px-10 transition-colors duration-300`}>
        <div className="flex items-center gap-6 text-sm">
          <a href="tel:(225) 555-0118" className="flex items-center gap-2 hover:text-blue-400">
            <Phone size={16} /> (225) 555-0118
          </a>
          <a href="mailto:buse.clskn@example.com" className="flex items-center gap-2 hover:text-blue-400">
            <Mail size={16} /> buse.clskn@example.com
          </a>
        </div>
      ...
      <div className="bg-white py-4 px-4 md:px-10 flex items-center justify-between border-b border-gray-200">
        ...
        <nav className="hidden md:flex items-center gap-8 font-medium text-[#737373]">
          ...
          <Link to="/shop" className="text-[#252B42] font-semibold flex items-center gap-1">Shop</Link>
        ...
        <div className="flex items-center gap-4 md:gap-6 text-[#23A6F0]">
          ...
          <button className="md:hidden p-2 text-[#23A6F0]">
      ...
      {/* Shop Sayfasına Özel Banner */}
      {isShopPage && (
        <div className="bg-[#FAFAFA] py-8 px-6 md:px-12 w-full border-b border-[#ECECEC]">
